...
> **最后更新：** 2026-04-20（2e-1 完成 + 单端架构说明同步）
...
| Go ↔ Node | HTTP REST（docker-compose 内网） | 9 个 API：Router/Transport/Producer/Consumer 生命周期 |
